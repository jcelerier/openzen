...
#ifndef ZEN_PROPERTIES_IG1COREPROPERTIES_H_
#define ZEN_PROPERTIES_IG1COREPROPERTIES_H_
...
namespace zen
{
    class Ig1CoreProperties : public ISensorProperties
    {
    public:
        Ig1CoreProperties(SyncedModbusCommunicator& communicator, ISensorProperties& imu);
